...
import { addReminder, getRemindersForHabit, deleteReminder, updateReminderNotificationId } from '@/lib/database';
import { scheduleHabitReminder, cancelReminder, requestNotificationPermission, parseReminderTime, formatReminderTime24, openExactAlarmSettings } from '@/lib/notifications';
...
export default function EditHabitScreen() {
  ...
  const handleSave = async () => {
    ...
    // Delete old reminders + cancel HANYA notif habit ini (bukan semua habit)
