...
const translations = {
  en: {
    ...
    frequency: 'Frequency',
    reminder: 'Reminder',
    pickTime: 'Pick Time (24h)',
    reminderDenied: 'Enable it in Settings → Apps → MyHabits → Notifications + Alarms & reminders, then set the time again.',
    openSettings: 'Open Settings',
    exactAlarm: 'Exact alarm',
    exactAlarmHint: 'If late/missing: allow Alarms & reminders + Autostart for MyHabits.',
    batteryOpt: 'Ignore battery optimization',
    batteryOptHint: 'So reminders still fire with battery saver on.',
    testNotif: 'Test Notification (10 sec)',
    viewSchedule: 'View Scheduled',
    viewScheduleHint: 'Tap to see daily times + next fire',
    noSchedule: 'Nothing scheduled. Create a habit + reminder first.',
    hour: 'Hour',
    min: 'Min',
    period: 'Period',
    everyDay: 'Every Day',
  ...
  id: {
    ...
    frequency: 'Frekuensi',
    reminder: 'Pengingat',
    pickTime: 'Pilih Waktu (24 jam)',
    reminderDenied: 'Aktifkan di Settings → Apps → MyHabits → Notifications + Alarms & reminders, lalu pasang ulang jam.',
    openSettings: 'Buka Pengaturan',
    exactAlarm: 'Alarm tepat waktu',
    exactAlarmHint: 'Kalau telat/nggak muncul: izinkan Alarms & reminders + Autostart untuk MyHabits.',
    batteryOpt: 'Abaikan optimasi baterai',
    batteryOptHint: 'Biar reminder tetap bunyi walau battery saver nyala.',
    testNotif: 'Tes Notifikasi (10 detik)',
    viewSchedule: 'Lihat Jadwal Terpasang',
    viewScheduleHint: 'Tap untuk lihat jam daily + bunyi berikutnya',
    noSchedule: 'Tidak ada jadwal terpasang. Buat habit + reminder dulu.',
    hour: 'Jam',
    min: 'Menit',
    period: 'Periode',
